...
* [Prevención de zoonosis y enfermedades transmitidas por alimentos.](#zoonoses)
...
<br>
La priorización de poblaciones en mayor riesgo de sufrir agravios de salud es uno de los pilares de la epidemiología moderna, siendo otro de los pilares el rigor de métodos cuantitativos y la calidad de los datos utilizados. El descaso al que son sometidas las periferias se traduce no en la exposición sino en la imposición de factores de riesgo y las hace prioritarias desde el punto de vista epidemiológico. No obstante, del descaso también surge la falta de información y así el compromiso de uno de los pilares mencionados. La esencia de los modelos epidemiológicos es la simplificación de la realidad y frente a las dificultades traídas por la marginalización de la periferias, una simplificación conveniente para poder aplicar eses y asumir que las periferias no existen. Sin embargo, una cosa son los modelos epidemiológicos y otra la realidad epidemiológica. Periferias, desigualdades, iniquidades, decisiones políticas e intereses corporativos pueden ser ignorados en los modelos, pero eso no los elimina de la realidad epidemiológica de determinan. Retomando la prioridad que debe ser dada a las periferias, este estudio etnográfico aborda un punto básico y al mismo tiempo ampliamente ignorado en la epidemiología de la Covid-19: ¿Como ha sido la vivencia de la pandemia de acuerdo con los propios residentes de las periferias? Las respuestas están revelando serias dificultades para cualquier intento de control restricto al uso de máscaras, alcohol y al distanciamiento social de 2 metros. Al considerar colectivos multiespecie periféricos, estudio estudio refuerza algo que ha sido olvidado cuando no completamente ignorado: la Covid-19, como otras pandemias, surgió a partir de colectivos multiespecie marginalizados y está afectando a múltiples especies en diversas periferias. La investigación es financiada por la fundación Tide Setubal y es realizada por el Grupo de Pesquisa das Periferias del Instituto de Estudos Avançados ([nPeriferias](http://www.iea.usp.br/pesquisa/grupos-pesquisa/nperiferias)) por Oswaldo Santos Baquero, Júlia Amorim, Sara da Silva (Faculdade de Medicina - FM-USP), Dora Barrientos (Escola de Artes, Ciências e Humanidades - EACH-USP, nPeriferias-IEA-USP), Ana Claudia Germani (Faculdade Medicina - FM-USP, nPeriferias-IEA-USP) y Gislene Santos (EACH-USP, nPeriferias-IEA-USP).

<figure>
<img src="{{root}}/assets/projetos/covid01/ocupa.jpg" width=350 height=auto >
 <figcaption>Ocupación en el Jardim São Remo creada durante la pandemia, frente a la incapacidad de pagar arriendos.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/covid01/jand.jpg" width=350 height=auto >
 <figcaption>Familia multiespécie del Jardim São Remo. Encuentre el  perro en la foto!</figcaption>
</figure>
...
### <a name="silenciosas">Vigilancia de enfermedades desatendidas en áreas silenciosas.</a>

<br>
Algunas enfermedades están relativamente restrictas a las periferias, afectando a billones de personas y animales de colectivos marginalizados. A pesar del orden de grandeza, la industria farmacéutica poco invierte en esas víctimas porque son económicamente pobres y no atienden las expectativas de generación de lucro. Las organizaciones internacionales hablan de enfermedades desatendidas, pero en el fondo lo que se tiene son colectivos multiespecie sujetos por múltiples negligencias. De cualquier forma, las enfermedades también son desatendidas y subnotificadas, generando un cuestionamiento: ¿En las áreas silenciosas (sin ninguna notificación) de un municipios no hay casos o no fueron identificados? En el presente estudio están siendo usados modelos estadísticos espaciales para predecir la cantidad de casos de esporotricosis felina en las áreas silenciosas de la ciudad de Guarulhos, a partir de la situación epidemiológica de las áreas vecinas y de la vulnerabilidad social de las propias áreas silenciosas y de las áreas vecinas. El equipo esta compuesto por Lígia Neves Scuarcialupi, Fernando Cortéz Pereira (Centro de Controle de Zoonoses de Guarulhos) y Oswaldo Santos Baquero.

<figure>
<img src="{{root}}/assets/projetos/silen01/pred_0.jpg" width=350 height=auto >
 <figcaption>Exceso de riesgo (RE) de esporotricosis felina en los sectores censales de Guarulhos entre 2011 y 2019. Ese exceso de riesgo representa la probabilidad de que la densidad de casos en los sectores sea mayor que la densidad de casos en la ciudad. Aquí asumimos que los sectores censales silenciosos no tenían casos, una práctica común.</figcaption>
</figure>
...
<img src="{{root}}/assets/projetos/bemestar/oficina.jpg" width=350 height=auto >
 <figcaption>Actividad lúdica en el Circo Escola, Jardim São Remo.</figcaption>
</figure>
...
### <a name="mordeduras">Prevención de mordeduras.</a>
...
<img src="{{root}}/assets/projetos/eduambiental/entulho.jpg" width=350 height=auto >
 <figcaption>Los acúmulos de escombros son un problema recurrente en el Jardim São Remo.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/eduambiental/galinha.jpg" width=350 height=auto >
 <figcaption>Las gallinas son usadas para controlar los escorpiones que proliferam en los escombros. Repare en la gallina en el fondo de esta casa del Jardim São Remo.</figcaption>
</figure>
...
<img src="{{root}}/assets/projetos/zoonoses/riacho01.jpg" width=350 height=auto >
 <figcaption>Casas del Riacho Doce, Jardim São Remo.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/zoonoses/manfre.jpg" width=350 height=auto >
 <figcaption>Niño en el Riacho Doce del Jardim São Remo. Foto por Naima Manfre'.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/zoonoses/lampada.jpg" width=350 height=auto >
 <figcaption>Lámpara UV para ver como quedan las mãos aparentemente limpias, después uma lavado incorreto. Crico Escola, Jardim São Remo.</figcaption>
</figure>
