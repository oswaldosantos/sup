...
* [Translucid OHP.](#trans01)
* [Evaluation of handwashing by children and adolescents of the São Remo favela (São Paulo, Brazil) using the theory of planned behavior.](#maos)
* [Participatory documentation of COVID-19 pandemic experiences in the São Remo favela, São Paulo, Brazil.](#covid01)
* [Dimensions of animal abuse perpetrated and witnessed by children and adolescents.](#viol02)
* [Surveillance of neglected diseases in silent (without reports) areas.](#silenciosas)
* [Companion animal wellfare.](#bemestar)
* [Dog bite prevention.](#mordeduras)
* [Environmental education.](#eduambiental)
* [Prevention of zoonoses and food-born diseases.](#zoonoses)
...
### <a name="trans01">Translucid OHP.</a>
<br>
...
### <a name="maos">Evaluation of handwashing by children and adolescents of the São Remo favela (São Paulo, Brazil) using the theory of planned behavior.</a>
<br>
...
<figcaption>Drawing by Sebastián Mora.</figcaption>
</figure>
...
### <a name="covid01">Participatory documentation of the COVID-19 pandemic experience in Jardim São Remo, São Paulo, SP.</a>
<br>
...
<img src="{{root}}/assets/projetos/covid01/ocupa.jpg" width=350 height=auto >
 <figcaption>Informal settlement in Jardim São Remo. Its building started amidst the pandemic due to unaffordable household rents.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/covid01/jand.jpg" width=350 height=auto >
 <figcaption>Multiespecies familiy in Jardim São Remo. Find the dog in the picture!</figcaption>
</figure>
...
### <a name="viol02"><Dimensions of animal abuse perpetrated and witnessed by children and adolescents./a>
...
### <a name="silenciosas"><Surveillance of neglected diseases in silent (without reports) areas./a>
...
<img src="{{root}}/assets/projetos/silen01/pred_0.jpg" width=350 height=auto >
 <figcaption>Excess risk (ER) of feline sporotrichosis in the census tracts of Guarulhos, between 2011 and 2019. This excess risk represents the probability that the density of cases in the sectors is greater than the density of cases in the city. Here we assumed that there was no cases on the silent sectors, a usual practice.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/silen01/pred_na.jpg" width=350 height=auto >
 <figcaption>Excess risk (ER) of feline sporotrichosis in the census tracts of Guarulhos, between 2011 and 2019. This excess risk represents the probability that the density of cases in the sectors is greater than the density of cases in the city. Here we assumed that there was no information on the silent sectors and predicted the number of cases.</figcaption>
</figure>
...
### <a name="bemestar">Companion animal wellfare</a>
...
<img src="{{root}}/assets/projetos/bemestar/oficina.jpg" width=350 height=auto >
 <figcaption>Playful activity at Circo Escola, Jardim São Remo.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/bemestar/rede.jpg" width=350 height=auto >
 <figcaption>Dog and cat welfare as understood by children from Circo Escola (NGO), Jardim São Remo. Each network point is a response option, and the colors distinguish three response profiles. We will present more details in a scientific publication.</figcaption>
</figure>
...
### <a name="eduambiental">Environmental education.</a>
...
<img src="{{root}}/assets/projetos/eduambiental/entulho.jpg" width=350 height=auto >
 <figcaption>The accumulation of rubble is a recurring problem in Jardim São Remo.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/eduambiental/galinha.jpg" width=350 height=auto >
 <figcaption>Chickens are used to control scorpions that proliferate in the rubble. Find the chicken in the backyard of this house in Jardim São Remo.</figcaption>
</figure>
...
### <a name="zoonoses">Prevention of zoonoses and food-born diseases.</a>
...
<img src="{{root}}/assets/projetos/zoonoses/riacho01.jpg" width=350 height=auto >
 <figcaption>Houses in Riacho Doce, Jardim São Remo.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/zoonoses/manfre.jpg" width=350 height=auto >
 <figcaption>Children from Riacho Doce, Jardim São Remo. Picture by Naima Manfre'.</figcaption>
</figure>

<figure>
<img src="{{root}}/assets/projetos/zoonoses/lampada.jpg" width=350 height=auto >
 <figcaption>UV lamp to see how seemingly clean hands look after an incorrect hand washing. Crico School, Jardim São Remo.</figcaption>
</figure>
...
Panoramic imagem by our friend Notable Salazar [@salazarnotable](https://www.instagram.com/salazarnotable/)
